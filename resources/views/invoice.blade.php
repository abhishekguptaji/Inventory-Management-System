...
<body>
  <style>
    ...
    table thead tr { background: #007bff; color: #fff; text-align: center; }
    table th, table td { border: 1px solid #ddd; padding: 8px; text-align: center; }
    tbody tr:nth-child(even) { background: #f9f9f9; }
    tbody tr.total { font-weight: bold; background: #f1f1f1; text-align: right; }
    tbody tr.total td { padding: 6px; }
